...
Na versão 1.2.5, o Companion também reconhece as URLs universais `/up/MLBU...` usadas pelo Radar e restaura automaticamente a sessão cifrada quando o backend solicita uma nova sincronização. Ele usa o contexto autenticado da página oficial quando o Mercado Livre recusa chamadas iniciadas pelo service worker. O botão **Desconectar deste navegador** sempre remove a credencial local, mesmo quando o servidor antigo está indisponível, e o **AfiliHub online** é o ambiente padrão.
