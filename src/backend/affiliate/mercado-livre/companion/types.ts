export const PROMOFY_COMPANION_EXTENSION_VERSION = '1.1.0';
export const MERCADO_LIVRE_COMPANION_ADAPTER_VERSION = 4;
export const MINIMUM_MERCADO_LIVRE_COMPANION_ADAPTER_VERSION = 4;
